...
columns = ['ACFT_MAKE_NAME', 'LOC_STATE_NAME', 'ACFT_MODEL_NAME', 'RMK_TEXT', 'FLT_PHASE', 'EVENT_TYPE_DESC',
           'FATAL_FLAG']
...
# Replace all Fatal Flag missing values with the required output and verify if the missing values are replaced
...
# Check the number of observations to compare it with the original dataset and see how many values have been dropped
print(df_new.shape)
print("\n")
