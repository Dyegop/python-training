"""
PYINPUTPLUS:
-A module that contains functions similar to input() for several kinds of data: numbers, dates, email addresses
and more.
"""
...
# inputChoice()   -> ensures the user enters one of the provided choices, and return selected choice as string
...
# inputFilepath() -> ensures the user enters a valid file path and filename, and can optionally check that file exists
# inputPassword() -> similar the built-in input(), but displays * characters as the user types so that passwords,
